...
export function Card({
    ...
    return (
        <div
            className={`rounded-2xl border bg-white p-6 shadow-sm transition ${className}`}
        >
            {children}
        </div>
    );
    ...
    return (
        <div className="flex items-center justify-between py-2">
            ...
            <button
                ...
                className={`relative h-6 w-11 rounded-full transition ${checked ? "bg-green-500" : "bg-gray-300"
                    }`}
            >
                <span
